            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <select name="ratingSPR" id="ratingSPR" class="custom-select shoulder_valid" db-table="prod_left_shoulder" required="required">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <select class="custom-select shoulder_validR" db-table="prod_right_shoulder" name="persistedSPR" id="persistedSPR" required="required">
                                <option value="">Choose...</option>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="causeSPR" id="" cols="30" rows="10"></textarea>
                        </div>
                    </div>
                </div>
                <div class="row pb-3">
                    <div class="col-md-12">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="patientInjurySPR" id="patientInjurySPR_yes" value="Yes" required="required" />
                            <label class="form-check-label" for="patientInjurySPR_yes">Yes</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="patientInjurySPR" id="patientInjurySPR_no" value="No" required="required" />
                ...
                <div class="row pb-3">
                    <div class="col-md-12">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="surgerySPR" id="surgerySPR_yes" value="Yes" required="required" />
                            <label class="form-check-label" for="surgerySPR_yes">Yes</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="surgerySPR" id="surgerySPR_no" value="No" required="required" />
                ...
                <div class="row pb-3">
                    <div class="col-md-12">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="frequencySPR" id="frequencySPR_yes" value="constant" required="required" />
                            <label class="form-check-label" for="frequencySPR_yes">constant</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="frequencySPR" id="frequencySPR_no" value="intermittent" required="required" />
                ...
                <div class="row pb-3">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="aggravatesSPR[]" class="choices-multiple" placeholder="Can select multiple pains" multiple>
                ...
                <div class="row pb-3">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="treatmentsSPR[]" class="choices-multiple" placeholder="Can select multiple pain treatments" multiple>

        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <span style="display: block; font-size:12px">Please specify 'In Detail' the cause of
                                patient's pain (one word
                                descriptions are not adequate, enter a narrative statement of the issues causing pain if
                                possible)</span>
                ...
                <div class="row pb-3">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="painIncreases">Does the pain increase while bending forward or leaning
                                back?</label>
                        ...
                        <div class="form-group">
                            ...
                            <select class="choices-multiple" multiple name="BackPharmPrescriptionNumber" id="BackPharmPrescriptionNumber">
                                ...
                                <option value="83" prescription="PLIAGLIS 7-7% EXTERNAL CREAM">Apply 1gm topically to
                                    affected area(s) up to 4
                                    times daily. Peel off after waiting the required application time as directed. (Max
                                    application time of 60
                                    min) - 120 grams</option>
                                <option value="82" prescription="Kamdoy Skin Emulsion">Apply 2ml (6 sprays=1ml) to
                                    affected area 3 - 4 times a
                                    day - 240mL</option>
                                <option value="80" prescription="HAPRODERM GEL">Apply 1-2 grams of gel to the affected
                                    area(s) and allow to
                                    dry. Reapply up to 3 times daily (or as needed) 1 gram = 1 dime size - 180 Grams
                                </option>
                                <option value="81" prescription="Atopaderm cream">Apply 2 to 3 grams into palm and apply
                                    to affected area 3
                                    times daily. Massage gently into dry skin until completely absorbed. If skin is
                                    broken, cover with appropriate
                                    dressing - 200 gm</option>
                                <option value="67" prescription="Fenoprofen 200mg">Take 1 tablet every 4 to 6 hours as
                                    needed - 540 Capsules
                                </option>
                                <option value="68" prescription="Chlorzoxazone 250mg">Take 1 to 2 tablets by mouth 3-4
                                    times daily as needed
                                    for muscle spasms - 360 Tablets</option>
                                <option value="69" prescription="Ketoprofen 25mg Capsule">Take 2-3 capsules with a full
                                    glass of water up to
                                    three times daily - 720 Capsules</option>
                                <option value="70" prescription="TRIAMCINOLONE OINTMENT 0.05%">Apply 2 to 4 g to the
                                    affected area 2 to 4 times
                                    daily as needed - 430G</option>
                                <option value="72" prescription="DOXEPIN 5% CREAM">Apply 1-2 grams of cream to affected
                                    area up to 4 times
                                    daily as needed for pain - 225GRMS</option>
                                <option value="73" prescription="Calcipotriene/Betamethasone 0.005%/0.064% Ointment">
                                    Apply 1-3 grams topically
                                    to affected area(s) up to 4 times daily - 240 grams</option>
                                <option value="77" prescription="Diclovix">Apply 2.5ml of diclofenac solution to
                                    affected areas 4 times daily
                                    as needed (20 drops=1ml) and apply 1 patch up to twice daily as needed - 1 Tube
                                </option>
                                <option value="66" prescription="Orphenadrine/Aspirin/Caffeine 50/770/60 MG Tablets">½
                                    to 1 tablet PO 3 to 4
                                    times daily. - 360 Tablets</option>
                                <option value="33" prescription="Pliaglis">Pliaglis (Lidocaine and Tetracaine) Cream 7%
                                    / 7%
                                    Apply 2-3 grams topically to affected area(s) up to four times daily. Peel off after
                                    waiting the
                                    required application time as directed. (Maximum application time of 60 minutes) Qty:
                                    240 grams - 240 grams
                                </option>
                                <option value="34" prescription="Chlorzoxazone 375 mg Tablet">Take 1 tablet by mouth 3-4
                                    times daily as needed
                                    for muscle spasms - 120 Tablets/ 375 mg each tablet</option>
                                <option value="35" prescription="Cyclobenzaprine 7.5 mg Tablet">Take 1 tablet by mouth 3
                                    times daily as needed
                                    for muscle spasms - 90 Tablets 7.5mg each tablet</option>
                                <option value="47" prescription="Ketoprofen 25mg Capsule">Take 2-3 capsules with a full
                                    glass of water up to
                                    three times daily - 270 Capsules</option>
                                <option value="50" prescription="Chlorzoxazone 250mg">Take 1 tablet by mouth 3-4 times
                                    daily as needed for
                                    muscle spasms - 120 Tablets</option>
                                <option value="52" prescription="Fluovix">Apply 2-3 grams once or twice daily to
                                    affected pain area(s). - 1
                                    TUBE</option>
                                <option value="56" prescription="Dermacinrx Lexitral Pharmapak -">Pharmapak - A 40 DROPS
                                    (2-3 ML) TO
                                    BACK/JOINTS/KNEES AND CREAM QID PP - 387 mL</option>
                                <option value="60" prescription="Diclofenac Potassium Tablets USP 25mg">Take 2 tablets
                                    by mouth three times
                                    daily as needed for pain - total daily dose of 150mg divided into three doses. Each
                                    tablet equals 25mg - 180
                                    Tablets</option>
                                <option value="62" prescription="Fenoprofen 200mg">Take 1-2 capsules by mouth 3-4 times
                                    daily as needed for
                                    pain - 180 Capsules</option>
                                <option value="63" prescription="Orphenadrine/Aspirin/Caffeine 50/770/60 MG Tablets">1/2
                                    to 1 tablet PO 3 to 4
                                    times daily. - 120 Tablets</option>
                                <option value="64" prescription="Diclofenac Potassium 25mg Tablets">Take 1 to 2 tablets
                                    PO Three time daily -
                                    540 Tablets</option>
                                <option value="85" prescription="Metaxalone 800mg">Take 1 tablet 3-4 times daily as
                                    needed for muscle spasms -
                                    Qty 120 Tablets</option>
                                <option value="86" prescription="Lidocaine 5% Ointment">Apply 1-2 grams to affected
                                    area(s) 3-4 times daily. 1
                                    gram =1 dime size - Qty 70.88 Grams</option>
                                <option value="87" prescription="Diclofenac 3% Gel">Apply 1-2 grams to affected area(s)
                                    3-4 times daily. 1
                                    gram=1 dime size - Qty 100 Grams</option>
                                <option value="88" prescription="Naproxen ER 375mg">Take 1 tablet once daily as needed
                                    for pain - Qty 60
                                    Tablets</option>
                                <option value="89" prescription="Desonide 0.05% Gel">Apply to affected area 2 to 4 times
                                    daily as needed. - Qty
                                    240gm - 30 day supply</option>
                                <option value="91" prescription="Desonide 0.05% Gel">Apply to affected area 2 to 4 times
                                    daily as needed. - Qty
                                    720gm - 90 day supply</option>
                                <option value="93" prescription="Cyclobenzaprine ER 15mg Capsule">Take 1 capsule by
                                    mouth once daily as needed
                                    for muscle spasms - 30 Capsules</option>
                                <option value="94" prescription="Naproxen 125mg/5ml Suspension">Take 10-20ml's by mouth
                                    twice daily as needed
                                    for pain - 946mls</option>
                                <option value="95" prescription="Diclofenac 3% Gel">Apply 1-2 grams to affected area(s)
                                    3-4 times daily. 1
                                    gram=1 dime size - QTY 200 Grams</option>
                                <option value="97" prescription="Diclofenac Potassium 25 MG Oral Capsule">Take 2
                                    capsules by mouth up to 3
                                    times daily as needed for pain - total daily dose of 150mg divided into three doses.
                                    Each capsule equals 25mg.
